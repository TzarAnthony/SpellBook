...
@OnlyIn(Dist.CLIENT)
public class GhostHorseModel<T extends AbstractHorse> extends AgeableListModel<T> {
    ...
    public GhostHorseModel(ModelPart p_170668_) {
        super(RenderType::entityTranslucent, true, 16.2F, 1.36F, 2.7272F, 2.0F, 20.0F);
