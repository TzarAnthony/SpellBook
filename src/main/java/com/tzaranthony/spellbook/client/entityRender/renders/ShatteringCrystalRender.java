...
public class ShatteringCrystalRender extends EntityRenderer<ShatteringCrystal> {
    ...
    public ShatteringCrystalRender(EntityRendererProvider.Context p_174100_) {
        super(p_174100_);
        this.model = new EvokerFangsModel<>(p_174100_.bakeLayer(ModelLayers.EVOKER_FANGS));
//        FallingBlockRenderer
    }

    public void render(ShatteringCrystal p_114528_, float p_114529_, float p_114530_, PoseStack p_114531_, MultiBufferSource p_114532_, int p_114533_) {
