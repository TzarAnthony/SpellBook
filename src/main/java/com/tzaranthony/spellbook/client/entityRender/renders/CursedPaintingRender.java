...
import com.tzaranthony.spellbook.client.entityRender.renders.managers.CursedPaintingTextureManager;
...
//TODO: make this work. It currently keeps grabbing the default textures
public class CursedPaintingRender extends PaintingRenderer {
    public static final CursedPaintingTextureManager CPTM = new CursedPaintingTextureManager(Minecraft.getInstance().getTextureManager());

    public CursedPaintingRender(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public void render(Painting p_115552_, float p_115553_, float p_115554_, PoseStack p_115555_, MultiBufferSource p_115556_, int p_115557_) {
        ...
        this.renderPainting(p_115555_, vertexconsumer, p_115552_, motive.getWidth(), motive.getHeight(), CPTM.get(motive), CPTM.getBackSprite());
        p_115555_.popPose();
    ...
    public ResourceLocation getTextureLocation(Painting p_115550_) {
        return CPTM.getBackSprite().atlas().location();
    }
