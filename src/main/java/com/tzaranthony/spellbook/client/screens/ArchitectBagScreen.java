...
public class ArchitectBagScreen extends SBBagScreen<BuilderBagMenu> {
    private static final ResourceLocation MENU = new ResourceLocation("spellbook:textures/gui/architect_bag.png");

    public ArchitectBagScreen(BuilderBagMenu menu, Inventory inventory, Component component) {
    ...
    protected void renderBg(PoseStack pose, float partialTick, int x, int y) {
        //TODO: LoomScreen render like to make the patterns
