...
public class SummonedRangedBowAttackGoal<T extends SBSummonedEntity & RangedAttackMob> extends Goal {
    private final T mob;
    ...
    public SummonedRangedBowAttackGoal(T p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
