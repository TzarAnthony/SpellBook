...
public class SBBlocks {
    ...
    public static final RegistryObject<Block> CRYSTALLIZED_ENDER_CLUSTER = registerBlockAndRareUnburnableItem("crystallized_ender_cluster", () -> new EnderCrystal(8, 2, SoundType.AMETHYST_CLUSTER, 10), Rarity.RARE); //TODO: make it solidify from a liquid over ice, create transparent and cutout render
