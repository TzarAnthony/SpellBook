...
public class SBSpellRegistry {
    ...
    // sorcery
    public static final Spell FIREWALL = new Firewall(9, "firewall", SpellTier.NOVICE);
    ...
    public static final Spell OUTWARD_WINDS = new ProjectileSpell(12, "outward_winds", SpellTier.NOVICE); //TODO: remove?? -- pushes all entities around the user away
    ...
    public static final Spell RIFT_OF_DARKNESS = new DarkRift(28, "rift_of_darkness", SpellTier.MASTERY, SBBlocks.BLACK_HOLE);
    public static final Spell TIME_SPELL = new Time(29, "time_spell", SpellTier.MASTERY, SBBlocks.TIMER); //TODO: consider permanently de-age mobs
